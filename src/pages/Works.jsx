          ...
          <div className='row grid-items border-line-v'>
            <div className='col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h'>
              <div className='box-item'>
                <div className='image'>
                  ...
                  <img src='/assets/images/works/work1.jpg' alt='Motorcycle Helmet' />
                    <span className='info'>
                ...
                <div className='desc'>
                  <a href='/assets/images/works/work1.jpg' className='name has-popup-image'>
                    Motorcycle Helmet
                  </a>
              ...
              <div className='box-item'>
                <div className='image'>
                  <a href='https://vimeo.com/97102654' className='has-popup-video'>
                    <img src='/assets/images/works/work2.jpg' alt='Minimalism Shapes' />
                    <span className='info'>
            ...
            <div className='col col-d-6 col-t-6 col-m-12 grid-item music border-line-h'>
              <div className='box-item'>
                <div className='image'>
                  ...
                  >
                    <img src='/assets/images/works/work3.jpg' alt='Staircase' />
                    <span className='info'>
              ...
              <div className='box-item'>
                <div className='image'>
                  <a href='#popup-1' className='has-popup-media'>
                    <img src='/assets/images/works/work4.jpg' alt='Mobile Application' />
                    <span className='info'>
              ...
              <div className='box-item'>
                <div className='image'>
                  <a href='#gallery-1' className='has-popup-gallery'>
                    <img src='/assets/images/works/work5.jpg' alt='Gereal Travels' />
                    <span className='info'>
                      <span className='ion ion-images'></span>
                    </span>
                  </a>
                  <div id='gallery-1' className='mfp-hide'>
                    <a href='/assets/images/works/work6.jpg'></a>
                    <a href='/assets/images/works/work1.jpg'></a>
                    <a href='/assets/images/works/work5.jpg'></a>
                  </div>
                </div>
                <div className='desc'>
                  <a href='/assets/images/works/work5.jpg' className='name has-popup-image'>
                    Gereal Travels
                  </a>
              ...
              <div className='box-item'>
                <div className='image'>
                  <a
                    ...
                    className='has-popup-music'
                  >
                    <img src='/assets/images/works/work8.jpg' alt='Daylight Entrance' />
                    <span className='info'>
                      <span className='ion ion-music-note'></span>
                    </span>
                  </a>
            ...
            <div className='col col-d-6 col-t-6 col-m-12 grid-item video border-line-h'>
              <div className='box-item'>
                <div className='image'>
                  <a href='https://vimeo.com/97102654' className='has-popup-video'>
                    <img src='/assets/images/works/work6.jpg' alt='Architecture' />
                    <span className='info'>
                      <span className='ion ion-videocamera'></span>
                    </span>
                  </a>
              ...
              <div className='box-item'>
                <div className='image'>
                  <a href='#popup-2' className='has-popup-media'>
                    <img src='/assets/images/works/work7.jpg' alt='Social Website' />
                    <span className='info'>
                      <span className='ion ion-images'></span>
                    </span>
                  </a>
